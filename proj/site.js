...
Sim.prototype.dotOn = function(num) {
	this.indicatorDotsAll[num].style.cssText = 'background-color:rgb(0, 65, 163); cursor:pointer;'
};

Sim.prototype.dotOff = function(num) {
	this.indicatorDotsAll[num].style.cssText = 'background-color:rgb(2, 210, 238); cursor:default;'
};
...
Sim.initialize = function(that) {
	...
	else if(that.options.auto) {   // инициализация автопрокрутки
		setAutoScroll();
...
const anchors = document.querySelectorAll('a.scrolltop')
